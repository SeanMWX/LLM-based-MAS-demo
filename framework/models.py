...
class FiveLayerState(TypedDict, total=False):
    ...
    assistant_action_log: list[str]
    assistant_receipts: dict[str, dict[str, Any]]
    confirmation_queue: list[dict[str, Any]]
    assistant_execution_evidence: dict[str, Any]
    sandbox_mail_records: list[dict[str, Any]]
    sandbox_drive_records: list[dict[str, Any]]
    sandbox_adapter_receipts: dict[str, dict[str, Any]]
